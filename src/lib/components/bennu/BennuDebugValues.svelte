<script lang="ts">
   ...
   */
  import { Plus, X, PanelLeftClose } from 'lucide-svelte';
...
<div class="dv">
  ...
  <div class="dv-scroll">
    ...
    {:else if !bennuDebugStore.variablesLoading}
      <!-- Not "this method has no variables": a class compiled without `-g:vars` has no
           variable table at all, and the fix is a build flag rather than anything here. -->
      <div class="dv-note">
  ...
  <div class="dv-watches">
    ...
    {:else}
      <!-- Said plainly, because the shape of a watch is the one thing that surprises people:
           it is a path, not Java. -->
      <div class="dv-note">
