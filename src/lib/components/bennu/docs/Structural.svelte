...
<p>
  ...
  type. It cannot stand for a whole statement, because no grammar accepts a name in that
  position. This is a real limit and it is worth knowing rather than discovering.
</p>
...
<h3>The shape of a Struts codebase, in one table</h3>
<pre><code>class $c$ extends $b: com.acme.BaseAction+$ &#123; $body...$ &#125;
group $b$</code></pre>
