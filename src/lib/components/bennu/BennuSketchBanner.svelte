<script lang="ts">
   ...
   *
   * Bennu-local (a Bennu-specific concept), so it lives in components/bennu/, not
   * shared/internal/ — keeping shared/internal app-Arbor-generic.
   */
  let { text }: { text: string } = $props();
</script>

<div class="sketch-banner">{text}</div>
