...
<div class="feature-grid">
  ...
  <div class="feature-card">
    <div class="fc-title">grove (Music)</div>
    <div class="fc-desc">A standalone music live-coding studio — code editor, arrangement, mixer and a live audio engine — in its own window. Open it from the Command Palette under <em>Open grove (Music)</em>. See the <em>grove (Music)</em> section.</div>
  </div>
</div>
