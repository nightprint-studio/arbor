...
<p class="doc-lead">When you open a folder that isn't a git repository, Arbor detects this automatically and offers to initialize one — no need to run <code>git init</code> in a terminal.</p>
...
<h2>Project tab</h2>
<ul>
  <li><strong>Description</strong> — stored in <code>.git/description</code> and added to the README if enabled</li>
  <li><strong>Default branch</strong> — choose <code>main</code>, <code>master</code>, <code>develop</code>, or a custom name</li>
  <li><strong>Initial commit</strong> — stages all created files and makes the first commit automatically</li>
  <li><strong>Author name / email</strong> — pre-filled from the global git config (<code>user.name</code> / <code>user.email</code>)</li>
</ul>
...
<div class="feature-grid">
  ...
  <div class="feature-card">
    ...
    <div class="fc-desc">MIT, Apache 2.0, GPL 3, LGPL 3, AGPL 3, BSD 2/3-Clause, ISC, MPL 2.0 — filled with your name and the current year.</div>
  </div>
</div>
...
<table class="shortcuts-table">
  ...
  <tbody>
    <tr><td><strong>None</strong></td><td>Local repo only — add a remote later</td></tr>
    <tr><td><strong>GitHub</strong></td><td>Creates the repo via the GitHub API and adds it as <code>origin</code>. Requires a GitHub token in Settings → Credentials.</td></tr>
