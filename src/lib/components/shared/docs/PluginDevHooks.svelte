...
<h1>Plugin Development â€” Hooks &amp; Events</h1>
<p>
...
<table class="shortcuts-table">
  ...
  <tbody>
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Lifecycle â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Git operations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    <tr><td><code>on_pre_commit</code></td><td>tab_id, message, amend â€” <strong>vetoable</strong> (return a string to block)</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Branch / tag â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Stash â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Rebase â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    <tr><td><code>on_rebase_start</code></td><td>tab_id, base, action_count</td></tr>
    <tr><td><code>on_rebase_abort</code></td><td>tab_id</td></tr>
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Git Flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Pipelines â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    <tr><td><code>on_pipeline_run_request</code></td><td>pipeline_id, tab_id? â€” fired only when the user presses Play on a <em>stub</em> def (empty <code>stages</code>); defs with non-empty stages are replayed directly. Handler must compile stages and call <code>arbor.pipeline.run</code></td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Merge Requests / Pull Requests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Issues â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Git notes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Workspaces â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Security â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Theme / branding â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
    ...
    <tr><td colspan="2" style="color:var(--text-muted);font-size:0.78rem;padding-top:0.6rem">â”€â”€ Schedulers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</td></tr>
...
<h2>Vetoable hooks â€” <code>on_pre_commit</code></h2>
<p>
...
<h2>arbor.events â€” subscribe and emit</h2>
<p>
  One namespace for both built-in lifecycle hooks (<code>on_repo_open</code>, <code>on_commit</code>, â€¦) and plugin-defined events. Subscribers don't have to distinguish the two: every event flows through the same <code>arbor.events.on(name, fn)</code>.
</p>
<p>
  <strong>Naming rule for plugin events:</strong> events are always published under the <em>publisher's</em> plugin name. If you call <code>arbor.events.emit("build-done", ...)</code> from the plugin <code>compile-action</code>, Arbor dispatches <code>compile-action:build-done</code> to every subscriber. If you include a colon yourself, the prefix must match your own plugin name â€” otherwise a runtime error is raised (this prevents one plugin from spoofing another's events).
</p>
<pre class="language-lua">{@html highlight(`-- â”€â”€ Publisher: plugins/compile-action/main.lua â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
<ul>
  <li><code>not_found</code> â€” the target plugin isn't loaded, or the requested method isn't registered</li>
  <li><code>plugin_disabled</code> â€” the target plugin is installed but disabled in the Plugin Manager</li>
  <li><code>handler_error</code> â€” the provider's handler raised while executing (message carries the Lua error)</li>
</ul>
<p>
...
<p>
  The event name passed to <code>arbor.events.on</code> may contain one or more <code>*</code> characters. Each <code>*</code> matches any sequence of characters â€” including empty strings and colon / dot separators â€” with no segment boundaries. Literal strings without <code>*</code> still require an exact match.
</p>
...
<div class="callout info">
  <strong>Note</strong>
  A plugin with at least one wildcard subscription bypasses the manifest hook filter â€” it will receive all built-in lifecycle hooks too (<code>on_commit</code>, <code>on_repo_open</code>, â€¦) even if they aren't declared under <code>[hooks]</code>. Handlers must tolerate varied payload shapes.
</div>

<h3>Discovering hooks at runtime â€” <code>arbor.hooks</code></h3>
<p>
...
<p>
  ...
  or <code>arbor.job.spawn&lbrace;on_done=â€¦&rbrace;</code> are <em>not</em> in the catalog â€” they're plugin-defined.
