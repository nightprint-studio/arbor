<script lang="ts">
  ...
  function buildBuiltinActions(): LeafAction[] {
    ...
    actions.push(
      ...
      { id: 'action:whats-new', kind: 'action', icon: 'Gift',  group: 'System',
        title: "Show What's New",
        subtitle: 'Release notes for the version of Arbor you are running',
        action: () => closeAndDispatch('arbor:open-whats-new') },
      { id: 'action:processes', kind: 'action', icon: 'Gauge',  group: 'System',
        title: 'Show Process Monitor',
        subtitle: "What Arbor is costing this machine — every backend, language server and run",
        action: () => closeAndDispatch('arbor:open-processes') },
      { id: 'action:mcp-activity', kind: 'action', icon: 'Activity',  group: 'System',
        title: 'Show AI Activity',
        subtitle: 'What an AI client is doing right now, and what it has done',
        action: () => closeAndDispatch('arbor:open-mcp-activity') },
      { id: 'action:mcp-tools',    kind: 'action', icon: 'Bot',       group: 'System',
        title: 'Show AI Tools',
        subtitle: 'Every tool Arbor exposes to an AI client, by product',
        action: () => closeAndDispatch('arbor:open-mcp-tools') },
