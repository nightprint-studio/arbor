...
<Modal {onClose} width="840px" height="540px" padBody={false} ariaLabel="Nemus Settings">
  {#snippet header()}
    <ModalHeader {onClose}>
      <Settings size={14} />
    ...
    {#snippet content()}
      {#if active === 'general'}
        <div class="section-header">
          <h2>General</h2>
          <p>Language defaults applied when a <code>.nemus</code> file doesn't set them itself.</p>
        </div>
        <div class="card">
