 ...
 *
 * Both push a live cps override through `nemusEngine.setCps` (staged on the BE at
 ...
 * signal in NemusShell). The source stays authoritative; nothing is written back.
 *
