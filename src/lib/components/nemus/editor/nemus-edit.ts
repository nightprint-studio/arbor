/**
 * nemus — surgical literal edits over the Tree-sitter CST (pure, CodeMirror-free).
 *
 * The "code-first" round-trip from `design/nemus/editing-model.md §1`: where a
...
import type { Tree, Node } from './nemus-lang';
