...
<NemusCode code={`n(c2 g1).inst("synth.bass")
...
<NemusCode code={`// c2 kick · cs2 side-stick · d2 snare · ef2 clap · fs2 closed-hat · bf2 open-hat
...
<NemusCode code={`speech("hello world")                       // the electronic default voice
...
<NemusCode code={`speech("warning").pitch(40).rate(64).throat(96)
