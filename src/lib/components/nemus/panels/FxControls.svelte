<script lang="ts">
   ...
   *
   * Imports only shared/ui + nemus-local. Knob-driven (keyboard-accessible) — the
  ...
  import type { EqKind } from '../editor/nemus-edit';
  import { eqResponseDb, logFreqAxis, freqToX, xToFreq, freqLabel } from './nemus-eq-response';
