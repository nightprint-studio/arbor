<script lang="ts">
  ...
  import CorvusBeDownOverlay from './CorvusBeDownOverlay.svelte';
  import MissingRepoState from './MissingRepoState.svelte';
  ...
  import GitBlameModal from './GitBlameModal.svelte';
  ...
  import RecentReposModal from './RecentReposModal.svelte';
  import DepsExplorerModal from './DepsExplorerModal.svelte';
  import { depsExplorerStore } from '$lib/stores/corvus/depsExplorer.svelte';
  ...
  import { bisectStore } from '$lib/stores/corvus/bisect.svelte';
  ...
  import { statsStore } from '$lib/stores/corvus/stats.svelte';
  import { securityStore } from '$lib/stores/corvus/security.svelte';
  import type { SecuritySummary } from '$lib/types/corvus/security';
  ...
  import { jsonStudioStore } from '$lib/stores/studio/json-studio.svelte';
  import { ronStudioStore } from '$lib/stores/studio/ron-studio.svelte';
  import { tomlStudioStore } from '$lib/stores/studio/toml-studio.svelte';
  import { yamlStudioStore } from '$lib/stores/studio/yaml-studio.svelte';
  import { propertiesStudioStore } from '$lib/stores/studio/properties-studio.svelte';
  ...
  import { openInIde } from '$lib/ipc/corvus/worktree';
  ...
  import { getMrDetail } from '$lib/ipc/corvus/mr';
  ...
  import type { BranchInfo } from '$lib/types/corvus/git';
  import { fly } from 'svelte/transition';
  import { cubicOut } from 'svelte/easing';

  import { animStore } from '$lib/stores/animations.svelte';
  import { tabsStore, setTabsPersistHook } from '$lib/stores/corvus/tabs.svelte';
  ...
  import { startIdeDetection } from '$lib/ipc/corvus/worktree';
  import { issuesStore, type IssueProvider } from '$lib/stores/corvus/issues.svelte';
  ...
  //   void import('$lib/components/studio/JsonStudioModal.svelte');
  //   void import('$lib/components/studio/RonStudioModal.svelte');
  //   void import('$lib/components/studio/TomlStudioModal.svelte');
  //   void import('$lib/components/studio/YamlStudioModal.svelte');
  //   void import('$lib/components/studio/PropertiesStudioModal.svelte');
    ...
    try {
      ...
      await workspacesStore.bootstrap({
        ...
        closeTab: async (tabId) => {
          try { await import('$lib/ipc/corvus/graph').then(m => m.closeRepo(tabId)); } catch { /* ignore */ }
...
<div class="shell">
  ...
  <Lazy gate={jsonStudioStore.open}       loader={() => import('$lib/components/studio/JsonStudioModal.svelte')} />
  <Lazy gate={ronStudioStore.open}        loader={() => import('$lib/components/studio/RonStudioModal.svelte')} />
  <Lazy gate={tomlStudioStore.open}       loader={() => import('$lib/components/studio/TomlStudioModal.svelte')} />
