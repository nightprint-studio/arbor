<script lang="ts">
  ...
  import { checkoutCommitSafe, resetToCommit } from '$lib/ipc/corvus/branch';
  ...
  import { cherryPick, revertCommit } from '$lib/ipc/corvus/stage';
  import { getGraph } from '$lib/ipc/corvus/graph';
  import { getStatus } from '$lib/ipc/corvus/stage';
  import { firePluginAction } from '$lib/ipc/plugin';
  import type { CommitNode } from '$lib/types/corvus/git';
