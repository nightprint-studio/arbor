<script lang="ts">
  ...
  import { graphColumnsStore } from '$lib/stores/corvus/graphColumns.svelte';
  ...
  import TicketPickerModal from '../TicketPickerModal.svelte';
  ...
  import { getGraph, getGraphForFile, getRepoFingerprint, exportGraphSvg } from '$lib/ipc/corvus/graph';
  import { themeStore } from '$lib/stores/theme.svelte';
  import { graphConfigStore } from '$lib/stores/corvus/graph_config.svelte';
  import { keybindingsStore } from '$lib/stores/keybindings.svelte';
  import { matchesBinding } from '$lib/utils/keybindings';
  import { getStatus } from '$lib/ipc/corvus/stage';
  import { validateRepoPath, reportRepoMissing } from '$lib/ipc/corvus/missing';
  import { getCommitDiffMeta, getCommitsRangeDiffMeta, getWorkdirDiff } from '$lib/ipc/corvus/diff';
  import { createBranch, createTag, checkoutBranch, stashSave } from '$lib/ipc/corvus/branch';
  ...
  import { pushBranch, openInBrowser } from '$lib/ipc/corvus/remote';
  ...
  import { ticketLinksStore } from '$lib/stores/corvus/ticket_links.svelte';
  import { notesStore } from '$lib/stores/corvus/notes.svelte';
  ...
  import { ensureAvatar } from '$lib/stores/corvus/avatars.svelte';
  import { tooltipForAction } from '$lib/utils/shortcut';
  import { tooltip } from '$lib/actions/tooltip';
  import type { CommitNode, GraphEdge as GraphEdgeData, RepoStatus, TicketLink, StashRef, RefLabel } from '$lib/types/corvus/git';
  import type { MergedMrHint } from '$lib/types/corvus/mr';
