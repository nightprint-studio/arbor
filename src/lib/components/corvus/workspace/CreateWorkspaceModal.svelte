<script lang="ts">
  ...
  import { WS_COLOR_COUNT, workspaceColorVar, SCRATCH_ID } from '$lib/types/corvus/workspace';
  import type { RepoRegistryEntryWithRoot } from '$lib/types/corvus/workspace';
