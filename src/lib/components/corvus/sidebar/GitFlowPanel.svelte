<script lang="ts">
  ...
  import type { GitFlowConfig, GitFlowStatus } from '$lib/types/corvus/git';
  ...
  import TicketPickerModal from '$lib/components/corvus/TicketPickerModal.svelte';
  import CreateMrModal from '$lib/components/corvus/mr/CreateMrModal.svelte';
