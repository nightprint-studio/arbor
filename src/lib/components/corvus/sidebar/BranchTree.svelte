<script lang="ts" module>
  ...
  export type BranchNode =
    ...
    | { kind: 'leaf';  path: string; branch: import('$lib/types/corvus/git').BranchInfo };
</script>
...
<script lang="ts">
  ...
  import { checkoutBranchSafe, checkoutRemoteAsLocalSafe, deleteBranch, deleteRemoteBranches, mergeBranch } from '$lib/ipc/corvus/branch';
