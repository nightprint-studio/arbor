<script lang="ts">
  ...
  import { getReflog } from '$lib/ipc/corvus/reflog';
  import { checkoutCommitSafe } from '$lib/ipc/corvus/branch';
  ...
  } from '$lib/ipc/corvus/recovery';
  import ContextMenu, { type MenuItem } from '$lib/components/shared/ContextMenu.svelte';
  import type { ReflogEntry, RecoveryEntry, RecoveryKind, RecoveryRestorePreview } from '$lib/types/corvus/git';
