<script lang="ts">
  ...
  import { getRepoFiles, startFileMetaScan, getRepoFingerprint } from '$lib/ipc/corvus/graph';
  import type { RepoFileEntry } from '$lib/types/corvus/git';
  import ContextMenu from '$lib/components/shared/ContextMenu.svelte';
  import { tooltip } from '$lib/actions/tooltip';
  import GitBlameModal from '$lib/components/corvus/GitBlameModal.svelte';
