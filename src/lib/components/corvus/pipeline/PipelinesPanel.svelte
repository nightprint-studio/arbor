<script lang="ts">
  ...
  } from '$lib/ipc/corvus/pipeline';
  import type { PipelineDef, PipelineRun, CiRun } from '$lib/types/corvus/pipeline';
  ...
  type CiCtx = { x: number; y: number; run: import('$lib/types/corvus/pipeline').CiRun };
