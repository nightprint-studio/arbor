<script lang="ts">
  ...
  import { listLocalBranches } from '$lib/ipc/corvus/branch';
  import { listCiWorkflows, createCiPipeline } from '$lib/ipc/corvus/pipeline';
  import type { CiProviderInfo, CiWorkflow } from '$lib/types/corvus/pipeline';
