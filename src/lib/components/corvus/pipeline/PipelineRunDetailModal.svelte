<script lang="ts">
  ...
  import type { StepRun, RunStatus } from '$lib/types/corvus/pipeline';
  import { cancelPipelineRun, resumePipelineRun, discardPipelineRun } from '$lib/ipc/corvus/pipeline';
