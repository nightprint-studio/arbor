<script lang="ts">
  ...
  import { branchNameForIssue, jiraDownloadAttachment } from '$lib/ipc/corvus/issues';
  import { findCommitsForTicket } from '$lib/ipc/corvus/ticket_links';
  ...
  import type { Issue, IssueStatus, IssueAttachment } from '$lib/types/corvus/issues';
  import type { LinkedCommitRef } from '$lib/types/corvus/git';
