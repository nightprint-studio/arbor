...
<script lang="ts" module>
  import { contributionStore as _store } from '$lib/stores/corvus/contribution.svelte';
  ...
  import type { PluginContribution as _Contribution } from '$lib/types/corvus/contribution';
