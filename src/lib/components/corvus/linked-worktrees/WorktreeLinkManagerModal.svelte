<script lang="ts">
  ...
  import { listRegistryWithRoots } from '$lib/ipc/corvus/workspace';
  import { type RepoRegistryEntryWithRoot, workspaceColorVar } from '$lib/types/corvus/workspace';
  import {
  ...
  } from '$lib/ipc/corvus/linkedWorktree';
  import type { WorktreeLink, AliasEntry, AliasGroup } from '$lib/types/corvus/linkedWorktree';
  import type { RepoRegistryEntry } from '$lib/types/corvus/workspace';
