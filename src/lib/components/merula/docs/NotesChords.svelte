...
<MerulaCode code={`n(c4 e4 g4 c5)     // an arpeggio
n(fs4 a4 d5)`} />

<h2>Chords</h2>
<MerulaCode code={`n(c4'maj)          // C major triad
n(d3'min7)         // D minor seventh
n(g3'5)            // power chord (root + fifth)`} />

<h2>Scale degrees</h2>
<MerulaCode code={`n(0 2 4).scale("c:major")   // degrees resolve against a scale → C E G
...
<h2>Transposing</h2>
<MerulaCode code={`theme.add(12)      // up one octave (semitones)
