<script lang="ts">
  /**
   * Manage merula **project workspaces** — Arbor-style named groups of `.merula`
...
<Modal {onClose} width="640px" height="540px" ariaLabel="Workspaces">
  ...
  <div class="ws">
    <p class="ws-lead">Group your <code>.merula</code> projects into named, colour-coded sets — switch between them from the title bar.</p>
