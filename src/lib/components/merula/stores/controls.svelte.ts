 ...
 * knobs (Fase 4 · merula_set_literal).
 *
 ...
 * knobs reflect the literal currently in the `.merula` source and commit straight
 ...
 * (`merula-edit.ts` → `MerulaEditor.commitControls`, relayed via `merulaStore`).
 */

import { parseMerula } from '../editor/merula-lang';
import {
