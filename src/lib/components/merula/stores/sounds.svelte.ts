/**
 * merula sounds store — the resolvable instrument list (registry introspection
 * via `merula_sounds`). Reflects what the engine can *actually* play: the
