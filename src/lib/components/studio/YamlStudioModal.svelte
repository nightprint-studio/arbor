...
<script lang="ts">
  ...
  import StudioConvertPreviewModal from './StudioConvertPreviewModal.svelte';
  import Studio from './Studio.svelte';
  import { tooltip } from '$lib/actions/tooltip';
  import { basename as fsBasename } from './helpers';
  ...
  import { yamlStudioStore, type YamlNodeKind } from '$lib/stores/studio/yaml-studio.svelte';
