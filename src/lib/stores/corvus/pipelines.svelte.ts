import type { PipelineDef, PipelineRun, RunStatus, CiProviderInfo, CiRun } from '$lib/types/corvus/pipeline';
...
import { listPipelineDefs, listPipelineRuns } from '$lib/ipc/corvus/pipeline';
