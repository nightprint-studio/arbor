...
use crate::lua_api::helpers::contrib_write::{
...
fn install_add_context_menu_item(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("add_context_menu_item", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_add_menu_item(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("add_menu_item", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_add_toolbar_action(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("add_toolbar_action", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_set_panel_content(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("set_panel_content", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
