...
fn install_contribute(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("contribute", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_contribute_patch(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("contribute_patch", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_unregister(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("unregister_contribution", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_declare_point(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("contribution_point", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_list_contributions(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    ...
    ui.set("list_contributions", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
