...
pub(crate) fn install(ctx: &ApiCtx, lua: &Lua, ui: &Table) -> Result<()> {
    let op_table = lua.create_table().map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    ...
    ui.set("operation", op_table).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_start(ctx: &ApiCtx, lua: &Lua, op_table: &Table) -> Result<()> {
    ...
    op_table.set("start", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_set_current(ctx: &ApiCtx, lua: &Lua, op_table: &Table) -> Result<()> {
    ...
    op_table.set("set_current", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_update_step(ctx: &ApiCtx, lua: &Lua, op_table: &Table) -> Result<()> {
    ...
    op_table.set("update_step", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_finish(ctx: &ApiCtx, lua: &Lua, op_table: &Table) -> Result<()> {
    ...
    op_table.set("finish", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
