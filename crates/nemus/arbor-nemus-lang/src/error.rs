...
//! the exact characters at fault (`design/nemus/architecture.md` — diagnostics
...
use arbor_nemus_pattern::prelude::{PatternError, SourceSpan};

/// A nemus language error, optionally located in the source.
...
pub enum LangErrorKind {
    ...
    Context(String),
    /// A `fn` (directly or mutually) calls itself — forbidden, nemus is total.
