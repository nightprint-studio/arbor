//! # arbor-nemus-lang
//!
//! The `.nemus` **language**: the bridge between source text and the pure
//! [`Pattern`](arbor_nemus_pattern::prelude::Pattern) algebra of
//! `arbor-nemus-pattern` (Fase 0). This is **Fase 1** — no audio, no scheduler.
//!
//! ```text
...
//! ```
//!
//! The layers are deliberately **decoupled** (`design/nemus/editing-model.md`):
