//! The **frozen contract** between `arbor-nemus-engine` (timing) and
//! `arbor-nemus-audio` (sound). This is the seam the two crates are developed
...
/// mapping (`design/nemus/architecture.md`, clock & tempo).
