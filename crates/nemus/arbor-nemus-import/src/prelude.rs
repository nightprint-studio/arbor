//! Canonical entry point for `arbor-nemus-import`'s public API.
//!
...
// ── One-call conversion ──────────────────────────────────────────────────────
pub use crate::convert::{midi_to_nemus, midi_to_song, smf_to_nemus};
...
pub use crate::emit::song_to_nemus;
