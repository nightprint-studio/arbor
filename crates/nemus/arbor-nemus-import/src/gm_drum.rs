//! General MIDI percussion key → nemus sound name.
//!
//! GM channel 10 assigns a fixed instrument to each note number (35 = acoustic
//! bass drum, 38 = acoustic snare, …). nemus drum samples follow the
...
/// Map a GM percussion key (channel 10 note number) to a nemus sound name.
