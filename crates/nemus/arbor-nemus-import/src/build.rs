//! Tiny constructors for `arbor-nemus-lang` AST nodes.
//!
...
pub(crate) fn let_item(name: &str, value: Expr) -> arbor_nemus_lang::prelude::Item {
    arbor_nemus_lang::prelude::Item::Let(arbor_nemus_lang::prelude::LetBind {
        name: ident(name),
        value,
        span: sp(),
    })
...
pub(crate) fn program(items: Vec<arbor_nemus_lang::prelude::Item>) -> Program {
    Program { items }
}
