...
//! and pushes their [`VoiceEvent`](arbor_nemus_audio::prelude::VoiceEvent)s.
//!
...
mod tests {
    use super::*;
    use arbor_nemus_audio::prelude::RecordingSink;
    use arbor_nemus_pattern::prelude::{audio, pure, seq, track, tracks, TempoMap};
