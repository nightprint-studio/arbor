...
//! [`AudioSink`](arbor_nemus_audio::prelude::AudioSink) or straight into a
//! [`Renderer`](arbor_nemus_audio::prelude::Renderer).
//!
...
fn frame_range_to_query_span(
    ...
    sample_rate: u32,
    frames: &Range<u64>,
) -> arbor_nemus_pattern::prelude::TimeSpan {
...
/// `ControlMap` into a [`VoiceSource`](arbor_nemus_audio::prelude::VoiceSource) +
/// [`VoiceParams`](arbor_nemus_audio::prelude::VoiceParams), pitch, and the
...
mod tests {
    ...
    fn maps_named_sound_with_default_params() {
        ...
        assert_eq!(ev.id, arbor_nemus_audio::prelude::VoiceId(7));
    ...
    fn delay_config_converts_cycle_fraction_to_frames() {
        use arbor_nemus_audio::prelude::{AudioCommand, DelayConfig};
    ...
    fn schedule_span_alternates_cat_across_cycles() {
        use arbor_nemus_pattern::prelude::cat;
