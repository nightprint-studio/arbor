...
// Re-export the schema-view DTOs so the trait + backends can name them
// alongside the other studio DTOs through one prelude.
pub use crate::schema::{CrateProbe, Schema, TypeSource};
