...
pub use crate::paths::{
    ...
    merula_config_dir, merula_config_path, merula_data_dir, merula_legacy_sibling_dirs,
    sitta_config_dir, sitta_config_path, sitta_data_dir, try_arbor_config_path, tyto_config_dir,
    tyto_config_path, tyto_data_dir,
};
pub use crate::profile::{
    ...
    set_active_profile, try_product_path, DEFAULT_PROFILE, PRODUCT_CORVUS, PRODUCT_MERULA,
