...
pub(crate) fn install(_ctx: &ApiCtx, lua: &Lua, arbor: &Table) -> Result<()> {
    let text_table = lua.create_table().map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    ...
    arbor.set("text", text_table).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_replace(lua: &Lua, text_table: &Table) -> Result<()> {
    ...
    text_table.set("replace", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_contains(lua: &Lua, text_table: &Table) -> Result<()> {
    ...
    text_table.set("contains", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_find_all(lua: &Lua, text_table: &Table) -> Result<()> {
    ...
    text_table.set("find_all", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
...
fn install_escape(lua: &Lua, text_table: &Table) -> Result<()> {
    ...
    text_table.set("escape", fn_).map_err(|e| PluginCoreError::Plugin(e.to_string()))?;
    Ok(())
}
