// merula — Tree-sitter external scanner.
//
...
bool tree_sitter_merula_external_scanner_scan(void *payload, TSLexer *lexer,
...
void tree_sitter_merula_external_scanner_destroy(void *payload) {
  free(payload);
}

unsigned tree_sitter_merula_external_scanner_serialize(void *payload, char *buffer) {
  Scanner *s = (Scanner *)payload;
...
void tree_sitter_merula_external_scanner_deserialize(void *payload, const char *buffer,
                                                    unsigned length) {
  Scanner *s = (Scanner *)payload;
