...
//! the exact characters at fault (`design/merula/architecture.md` — diagnostics
...
use merula_pattern::prelude::{PatternError, SourceSpan};

/// A merula language error, optionally located in the source.
...
pub enum LangErrorKind {
    ...
    Context(String),
    /// A `fn` (directly or mutually) calls itself — forbidden, merula is total.
