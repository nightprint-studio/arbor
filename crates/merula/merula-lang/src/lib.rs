//! # merula-lang
//!
//! The `.merula` **language**: the bridge between source text and the pure
//! [`Pattern`](merula_pattern::prelude::Pattern) algebra of
//! `merula-pattern` (Fase 0). This is **Fase 1** — no audio, no scheduler.
//!
//! ```text
...
//! ```
//!
//! The layers are deliberately **decoupled** (`design/merula/editing-model.md`):
