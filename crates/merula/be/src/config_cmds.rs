//! `config_cmds` domain — the typed **global** merula configuration
...
//! and the config types stay `pub` for the sibling domain modules (eval / render /
//! audio / packs / models / import) that read them.
