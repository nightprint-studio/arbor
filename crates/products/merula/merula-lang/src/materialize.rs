...
//!
//! `design/merula/editing-model.md §3`: the future editor "freezes" a generative
...
use merula_pattern::prelude::{ControlMap, Hap, SourceSpan, Time};
...
/// `n(c4 e4 g4)`), the unit a caller splices back into a `.merula` file.
...
/// MIDI semitone → a merula note name (`60 → c4`, `63 → ef4`). Canonical spelling
