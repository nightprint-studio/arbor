...
//! default synth** — merula always makes *a* sound.
//!
...
/// onto merula's four band-limited shapes; `pulse` aliases `square` (no PWM yet).
...
/// Whether a path looks like an audio file merula's decoder can read (WAV via
