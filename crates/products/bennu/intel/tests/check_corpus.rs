...
//! `crates/products/bennu/check/tests/corpus` (its README explains the corpus, the markers and how
...
//!
//! The javac-key → Bennu-check mapping is `bennu_check::javac` — the same table the langtools and
