...
pub fn check_file_resolved(
    ...
    if jdk_available {
        ...
        timed!("unresolved_static_imports", crate::source::imports::unresolved_static_imports(root, source, resolver));
        ...
        timed!("unresolved_types", crate::typing::types::unresolved_types_in(&nodes, source, &symbols, resolver));
        timed!("type_arg_arity", crate::typing::type_arg_arity::type_arg_arity_errors_in(&nodes, source, &symbols, resolver));
        timed!("undefined_var", crate::calls::undefined_var::undefined_var_errors_in(root, &nodes, source, &symbols, resolver));
        ...
        timed!("functional", crate::calls::functional::functional_errors_in(&nodes, source, &symbols, resolver));
        ...
        timed!("switch_label_type", crate::switching::switch_label_type::switch_label_type_errors_in(root, &nodes, source, &symbols, resolver, &cache));
