...
//! the use site is NOT allowed to see. The visibility sibling of [`crate::calls::members`]/[`crate::calls::fields`]:
...
/// The tree-driven core (mirrors [`crate::calls::members::unknown_members_in`]): iterate the shared `nodes`,
