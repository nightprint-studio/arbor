...
//!
//! Like [`crate::calls::undefined_var`], this is highly false-positive-prone (a bare name can bind through
...
use crate::support::scopes::{is_value_position, resolves_as_local, single_top_level_type};
...
/// instance-member reference. Mirrors [`crate::calls::undefined_var`]'s exclusion list; its only effect is
...
/// The tree-driven core (mirrors [`crate::calls::members::unknown_members_in`] /
/// [`crate::calls::undefined_var::undefined_var_errors_in`]): iterates the shared pre-collected `nodes`
...
fn check_reference(
    ...
    out.push(crate::engine::check_id::CheckId::StaticContextAccess.at(
        name_node,
