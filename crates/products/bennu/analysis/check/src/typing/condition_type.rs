...
/// shared per-file inference `cache`. Signature mirrors [`crate::typing::casts::type_compat_errors_in`].
...
fn err(message: String, node: Node) -> Diagnostic {
    crate::engine::check_id::CheckId::NonBooleanCondition.at(node, message)
}
