...
//! [`crate::switching::switches`] (which verifies each ARM produces a value); here we verify the SET of arms
//! covers the enum.
//!
...
///
/// Resolver-backed signature (mirrors [`crate::typing::casts::type_compat_errors_in`]): the caller's already
