...
//! inferred type. The field counterpart to [`crate::calls::members`]: same inference, same conservative
...
use crate::support::walk::hierarchy_has;
...
fn check_access(
    ...
    if !has {
        out.push(crate::engine::check_id::CheckId::UnknownField.at(
            field,
