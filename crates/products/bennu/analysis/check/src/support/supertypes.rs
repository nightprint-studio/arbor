...
use crate::support::nodes::{is_class_type_node, text};
use crate::support::type_scope::TypeScope;
...
pub(crate) fn header_scope(decl: Node, bytes: &[u8], symbols: &FileSymbols) -> TypeScope {
    crate::support::resolve::enclosing_scope(decl, bytes, symbols)
}
...
pub(crate) fn binary(
    ...
    crate::support::resolve::type_binary_in(written, header_scope(decl, bytes, symbols), symbols, resolver)
}
