...
//! [`type_binary`](crate::support::resolve::type_binary) and the other with
//! [`type_binary_at`](crate::support::resolve::type_binary_at), so a nested parameter type resolved against
...
//! [`crate::support::supertypes`], which had five copies of its own.
