...
//!
//! Two checks need it and they want opposite answers from it. [`crate::throwing::checked_call`] asks "is any of
//! this NOT handled" and reports what escapes; [`crate::throwing::dead_catch`] asks "could this ever throw E"
