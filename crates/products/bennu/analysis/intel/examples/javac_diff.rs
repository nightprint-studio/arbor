...
//! * `WRONG`    — Bennu marks the line, but with a check the [`bennu_check::engine::javac`] table does not
...
//!
//! ```sh
//! python3 crates/products/bennu/analysis/intel/corpus/javac_diff_corpus.py /tmp/diffcorpus
