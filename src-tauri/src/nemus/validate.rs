...
//! — convenient for "nemus always makes a sound", but it hides typos like
...
use arbor_nemus::prelude::{ControlMap, Registry, Time, TimeSpan, Tracks};
...
pub fn known_instruments(cfg: &NemusConfig) -> HashSet<String> {
