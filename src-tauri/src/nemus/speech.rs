...
use arbor_nemus::prelude::{synthesize_speech_spec, DecodedAudio, Registry, SpeechSpec};
...
/// `%APPDATA%\nemus\speech-cache` — nemus's own data root (sibling of arbor).
fn cache_dir() -> PathBuf {
    arbor_core::prelude::nemus_data_dir().join("speech-cache")
}
