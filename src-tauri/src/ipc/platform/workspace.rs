...
use crate::commands::workspace_commands::{
    ...
    RepoHealth, RepoRegistrationResult, RepoRegistryEntryWithRoot,
...
// Background runners (fetch-all / pull-all / tag-all) split out to
// `crate::ipc::platform::workspace_runs`.
