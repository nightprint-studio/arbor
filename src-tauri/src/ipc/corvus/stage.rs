...
//!
//! **Not migrated, kept inline in `commands/stage_commands.rs`:** `commit` —
//! it fires the **vetoable** `on_pre_commit` hook and the `on_commit` hook,
//! which needs the plugin veto round-trip seam not yet built. No other handler
//! here fires a hook.
