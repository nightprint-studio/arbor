...
pub fn jira_tracker() -> Arc<JiraTracker> {
    JIRA.get_or_init(|| Arc::new(JiraTracker::new(Arc::new(VaultSessionProvider::jira()), "jira"))).clone()
}
...
pub fn registry() -> &'static IssueTrackerRegistry {
    REGISTRY.get_or_init(|| {
        ...
        reg.register(Arc::new(LinearTracker::new(Arc::new(VaultSessionProvider::linear()), "linear")));
