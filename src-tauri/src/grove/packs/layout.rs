...
//! maps to grove sound-registry entries.
//!
...
fn generate_sfz_tree(root: &Path) -> (String, usize) {
    ...
    let mut out = String::from("# Auto-generated sound registry (grove).\n\n");
...
/// Whether a path is an audio file grove can decode (matches the engine's set).
